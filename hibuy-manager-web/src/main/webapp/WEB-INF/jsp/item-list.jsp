...
<table class="easyui-datagrid" id="itemList" title="商品列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'cid',width:100">Leaf Category</th>
            <th data-options="field:'sellPoint',width:100">Highlights</th>
            <th data-options="field:'price',width:70,align:'right',formatter:TAOTAO.formatPrice">Price</th>
            <th data-options="field:'num',width:70,align:'right'">Inventory</th>
